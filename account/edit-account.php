                    ...
                    echo "<h2>Emergency contact information</h2>
                      ...
                      else if ($emergID == Null && isset($_GET["emergencyContact"]))
                      {
                          ...
                          echo "<div class=\"form-buttons\">
                                  ...
                                  <input type=\"button\" name=\"addEmerg\" value=\"Add emergency contact\" style=\"width: 200px;\" onclick=\"window.location='/account/edit-account.php?userID=" . $_GET["userID"] . "&amp;emergencyContact';\" />
                                </div>";
                      }
				?>
              </div>
